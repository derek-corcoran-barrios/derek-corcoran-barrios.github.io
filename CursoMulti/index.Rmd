...
+  Capítulo \@ref(CriteriosInfo) *Criterios de Información*: En este capítulo se aprenderá sobre la diferencia entre un modelos predictivo y explicativo. Cuando queremos trabajar con cada uno de ellos, y como usar los criterios de información para encontrar un balance entre predicción y explicación.
