...
```{r, echo = F, results='asis'}
equatiomatic::extract_eq(fit2g, use_coefs = TRUE, wrap = T,   coef_digits = 5, terms_per_line = 3
)
```
...
```{r, echo = F, results='asis'}
equatiomatic::extract_eq(fit2p, use_coefs = TRUE, wrap = T
                         #,   coef_digits = 5, terms_per_line = 3
)
```
...
```{r, echo = F, results='asis'}
equatiomatic::extract_eq(FitBin2, use_coefs = TRUE, wrap = T,   coef_digits = 3, terms_per_line = 3
)
```
