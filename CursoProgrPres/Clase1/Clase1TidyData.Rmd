...
cual de los siguientes códigos nos entregaran un vector `y` con los elementos 4 y 8:
...
En el sigiente data frame llamado DF:
...
cual de los siguientes códigos nos entregaran un data frame `DF2` con solo las filas con letras A y B, y solo las columnas Letra y Medida:

1. `DF2 <- DF[c(2,3),c(1,4)]`
2. `DF2 <- DF[2:3,1:4]`
3. `DF2 <- DF[c(1,4),c(2,3)]`
4. `DF2 <- DF[1:4,2:3]`
