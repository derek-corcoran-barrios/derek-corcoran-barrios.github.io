...
for (provider in esri) {
  l <- l %>% addProviderTiles(provider, group = provider) %>% 
    leaflet::addCircles(data = as_Spatial(dplyr::filter(Test, Ranking == "> 800")), group = "> 800", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "> 800")$Rank,"</b>", "<br>", 
    ...
    leaflet::addCircles(data = as_Spatial(dplyr::filter(Test, Ranking == "601 - 800")), group = "601 - 800", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "601 - 800")$Rank,"</b>", "<br>", 
