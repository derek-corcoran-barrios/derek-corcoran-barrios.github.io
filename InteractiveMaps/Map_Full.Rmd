...
l <- l %>% 
    leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "> 800")) ,  radius = 6, group = "> 800", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "> 800")$Rank,"</b>", "<br>", 
    ...
    leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "601 - 800")) ,  radius = 6, group = "601 - 800", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "601 - 800")$Rank,"</b>", "<br>", 
    ...
    leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "401 - 600")),  radius = 6, group = "401 - 600", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "401 - 600")$Rank,"</b>", "<br>", 
    ...
    leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "201 - 400")),  radius = 6, group = "201 - 400", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "201 - 400")$Rank,"</b>", "<br>", 
  ...
  leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "2 - 200")),  radius = 6, group = "1 - 200", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "2 - 200")$Rank,"</b>", "<br>", 
    ...
    leaflet::addCircleMarkers(data = as_Spatial(dplyr::filter(Test, Ranking == "Richness Trend")),  radius = 6 , group = "Richness Trend", color = ~pal(Ranking), popup = paste("<b>Ranking:", dplyr::filter(Test, Ranking == "Richness Trend")$Rank,"</b>", "<br>", 
...
l %>% addSearchFeatures(targetGroups = c("Richness Trend", "1 - 200", "201 - 400", "401 - 600", "601 - 800", "> 800")) %>% 
  addLegend("bottomright", pal = pal ,title = "Rank",opacity = 1, values = Test$Ranking) %>%
