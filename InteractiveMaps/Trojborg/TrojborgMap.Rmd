...
Trojborg_outline <- Trojborg %>% st_union() %>% st_as_sf()
...
l <- l %>% 
  ...
  addPolygons(data = as_Spatial(Trojborg_outline), color = "blue", fillOpacity = 0, group = "Outline") %>% 
