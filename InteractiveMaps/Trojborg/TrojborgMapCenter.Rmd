...
l <- l %>% 
  ...
  addLegend("bottomright", pal = pal ,title = "Trojborg sites",opacity = 1, values = Trojborg_Centroids$Group,  group = "Legend") %>% 
  addLayersControl(baseGroups = names(esri),
                   overlayGroups = c("Points", "Groups", "Monitoring", "Roads", "Large groups", "Outline", "Legend"),
                   options = layersControlOptions(collapsed = TRUE),
                   position = "topright") %>%
  addMeasure(position = "topleft",
             primaryLengthUnit = "meters",
             primaryAreaUnit = "hectares") %>% 
  hideGroup(c("Groups","Large groups", "Legend"))
