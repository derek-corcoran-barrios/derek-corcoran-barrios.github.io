...
```{r scatterLoess, fig.cap='Gráfico en el cual vemos el peso de pollos en el tiempo, con colores distintos según el tipo de dieta', out.width='80%', fig.asp=.75, fig.align='center', echo = TRUE, cache = TRUE}
