...
La última versión de RStudio y R [@R-base], también se requiere de los paquetes *pacman*, *tidyverse* y *tinytex*. El código para la instalación de esos paquetes es el siguiente
