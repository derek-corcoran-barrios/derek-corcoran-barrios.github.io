...
1. Tidy Data, optimización de base de datos, limpieza y transformación de bases de datos.

2. Investigación reproducible. Generación de documentos Rmarkdown en R, códigos en chunk y en texto. Generación de tablas en Rmd

3. El Hadleyverso y el tidyverso, el concepto de pipeline. LImpieza de  datos complejos
