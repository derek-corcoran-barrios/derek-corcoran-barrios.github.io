...
3. Investigación reproducible. Generación de documentos Rmarkdown en R, códigos en chunk y en texto. Generación de tablas en Rmd
    + En el Capitulo \@ref(reproducible) entenderemos el como generar un documento que combine códigos de `R` y texto para generar documentos reporducibles utilizando el paquete *rmarkdown* [@Allaire2018]
    
4. El tidyverso, el concepto de pipeline. Limpieza de  datos complejos
