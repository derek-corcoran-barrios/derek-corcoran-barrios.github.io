...
* To fire, drought, disease, etc
* Depends on intensity, type or frequency and how fast conditions change
...
* Rise of extreme weather effects

<iframe src="https://ourworldindata.org/grapher/number-of-natural-disaster-events?time=1900..2023&facet=entity&uniformYAxis=0&country=Drought~Flood~Wildfire~Extreme+temperature~Extreme+weather" loading="lazy" style="width: 100%; height: 400px; border: 0px none;"></iframe>
...
* With increased extreme events we have to worry about resilience
* Highly connected landscapes are more resilient
* More heterogeneous landscapes are more resilient
* We have to cover both aspects for restoration in landscape ecology
