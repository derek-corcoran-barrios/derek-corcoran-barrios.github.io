...
```{r}
# Replace 'image1.jpg' and 'image2.jpg' with the actual file paths or URLs of your images
#image1 <- "images/Beavers.png"
#image2 <- "images/Beavers2.png"
...
<div style="float: left; width: 40%;">
* Who, when and where became extinct
...
knitr::include_graphics("images/MVAs.png")
```
</div>
...
```{r, out.width="80%"}
knitr::include_graphics("images/SPARC.png")
```
...
> - First iteration: 
>    - Number of neighbors $\text{Human dimension} = -\text{Penalty} \cdot \text{nNeighbors}$
> - Second iteration:
